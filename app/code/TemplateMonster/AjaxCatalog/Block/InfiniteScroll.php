...
class InfiniteScroll extends Template
{
    ...
    protected function _getProductsCount()
    {
        ...
        $collection = $this->categoryRepository->get($this->_request->getParam('id'))->getProductCollection();
    ...
    {
        return $this->_scopeConfig->getValue('ajaxcatalog/config/ajaxcatalog_infinite_scroll',
    ...
    {
        return $this->_scopeConfig->getValue('ajaxcatalog/config/ajaxcatalog_infinite_pages',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
